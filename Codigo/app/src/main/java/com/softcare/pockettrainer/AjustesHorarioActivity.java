...
public class AjustesHorarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajustes_horario);
        ...
        Button backBtn = (Button) findViewById(R.id.backBtnAjustesHorario);
    ...
    public void Siguiente(View v){
        ...
        if(verificarCasillas()) {
            Intent i = new Intent(this, AjustesTiempoActivity.class);
